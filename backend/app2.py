...
app = Flask(__name__)
eye_cascade = cv2.CascadeClassifier("C:/Users/ASHMITH/Desktop/full stack/backend/haarcascade_eye.xml")
face_cascade = cv2.CascadeClassifier("C:/Users/ASHMITH/Desktop/full stack/backend/haarcascade_frontalface_default.xml")
